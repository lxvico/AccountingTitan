			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - AccountingTitan</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - AccountingTitan</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://accountingtitan.com/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
